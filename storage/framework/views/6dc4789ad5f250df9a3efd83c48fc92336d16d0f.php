...
<form class="text-center border border-light p-5" action="<?php echo e(route('add-process')); ?>" method="post">
    <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\data\resources\views/form.blade.php ENDPATH**/ ?>